...
/**
 * File parser for DCD trajectory files.
 */
class OVITO_PARTICLES_EXPORT DCDImporter : public ParticleImporter
{
    ...
    public:
        ...
        virtual Ovito::span<const SupportedFormat> supportedFormats() const override {
            static const SupportedFormat formats[] = {{ QStringLiteral("*.dcd"), tr("DCD Trajectory Files") }};
            return formats;
        }
