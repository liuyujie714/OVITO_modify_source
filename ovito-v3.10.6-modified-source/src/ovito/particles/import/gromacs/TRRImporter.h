...
class OVITO_PARTICLES_EXPORT TRRImporter : public ParticleImporter
{
    ...
    public:
        ...
        virtual Ovito::span<const SupportedFormat> supportedFormats() const override {
            static const SupportedFormat formats[] = {{ QStringLiteral("*.trr"), tr("Gromacs Full Precision Trajectory Files") }};
            return formats;
        }
...
public:
    ...
    Q_INVOKABLE TRRImporter(ObjectInitializationFlags flags) : ParticleImporter(flags) {
        setMultiTimestepFile(true);
        setRecenterCell(true);
    }

    /// Returns the title of this object.
    virtual QString objectTitle() const override { return tr("TRR"); }
